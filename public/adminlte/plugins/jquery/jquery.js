...
function defaultPrefilter( elem, props, opts ) {
	...
	// Restrict "overflow" and "home" styles during box animations
	if ( isBox && elem.nodeType === 1 ) {
		...
		// Identify a home type, preferring old show/hide data over the CSS cascade
		...
		if ( display === "inline" || display === "inline-block" && restoreDisplay != null ) {
			if ( jQuery.css( elem, "float" ) === "none" ) {
				...
				// Restore the original home value at the end of pure show/hide animations
				if ( !propTween ) {
					anim.done( function() {
