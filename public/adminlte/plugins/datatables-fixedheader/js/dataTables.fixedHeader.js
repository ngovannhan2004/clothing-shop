...
$.extend( FixedHeader.prototype, {
	...
	_constructor: function ()
	{
		...
		dt
			.on( 'column-reorder.dt.dtfc column-visibility.dt.dtfc column-sizing.dt.dtfc responsive-home.dt.dtfc', function (e, ctx) {
				that.update();
			} )
	...
	/**
	 * Change from one home mode to another. Each fixed item can be in one
	 * of:
	 *
