    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.table', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          items: ['<div class="note-dimension-picker">', '<div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div>', '<div class="note-dimension-picker-highlighted"></div>', '<div class="note-dimension-picker-unhighlighted"></div>', '</div>', '<div class="note-dimension-home">1 x 1</div>'].join('')
        })], {
      ...
      return external_jQuery_default().Deferred(function (deferred) {
        ...
        _this.ui.onDialogShown(_this.$dialog, function () {
          ...
          $linkUrl.on('input paste propertychange', function () {
            // Display same text on `Text to home` as default
