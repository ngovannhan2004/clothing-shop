    ...
    <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col">
            ...
            <div class="form-group ">
                ...
                <select id="tags" tags multiple="multiple" data-dropdown-css-class="select2-purple" class="form-control " name="tags[]">
                    <option value="0">Chọn tag</option><option value="0">Chọn tag</option>
