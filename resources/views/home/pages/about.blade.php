...
<div class="about-intro-area">
    <div class="container position-relative h-100 d-flex align-items-center">
        ...
        <div class="intro-left">
            <img src="{{asset('home/assets/images/about-image/intro-left.png ')}}" alt="" class="intro-left-image">
        </div>
        <div class="intro-right">
            <img src="{{asset('home/assets/images/about-image/intro-right.png ')}}" alt="" class="intro-right-image">
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-6 d-flex">
                <div class="service-left align-self-center align-items-center">
                    <img src="{{asset('home/assets/images/about-image/srevice-left-img.png ')}}" alt="" class="service-left-image">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 mb-lm-30px">
                ...
                <div class="team-wrapper">
                    <div class="team-image overflow-hidden">
                        <img src="{{asset('home/assets/images/team/1.jpg')}}" alt="">
                    </div>
            ...
            <div class="col-md-4 mb-lm-30px">
                ...
                <div class="team-wrapper">
                    <div class="team-image overflow-hidden">
                        <img src="{{asset('home/assets/images/team/2.jpg')}}" alt="">
                    </div>
                    <div class="team-content">
            ...
            <div class="col-md-4">
                ...
                <div class="team-wrapper">
                    <div class="team-image overflow-hidden">
                        <img src="{{asset('home/assets/images/team/3.jpg')}}" alt="">
                    </div>
                    <div class="team-content">
